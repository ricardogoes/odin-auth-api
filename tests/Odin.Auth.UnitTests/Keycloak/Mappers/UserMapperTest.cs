...
namespace Odin.Auth.UnitTests.Keycloak.Mappers
{
    ...
    public class UserMapperTest
    {
        ...
        public void ToUserRepresentation()
        {
            ...
            var user = new DomainEntity.User(userId, "unit.testing", "Unit", "Testing", "unit.testing@email.com", true);
            ...
            userRepresentation!.Enabled.Should().Be(user.IsActive);
        ...
        public void ToUserRepresentationList()
        {
            ...
            var user1 = new DomainEntity.User(userId1, "unit01.testing", "Unit01", "Testing", "unit01.testing@email.com", true);
            ...
            var user2 = new DomainEntity.User(userId2, "unit02.testing", "Unit02", "Testing", "unit02.testing@email.com", true);
            ...
            var users = new List<DomainEntity.User> { user1, user2 };
            ...
            usersRepresentation[0].Enabled.Should().Be(user1.IsActive);
            ...
            usersRepresentation[1].Enabled.Should().Be(user2.IsActive);
        ...
        public void ToUser()
        {
            var userRepresentation = new UserRepresentation
            {
                ...
                Attributes = new Dictionary<string, List<string>>
                {
                    ...
                    { "created_by", new List<string> { "value12" } },
                    { "last_updated_at", new List<string> { DateTime.Now.ToString("o") } },
                    { "last_updated_by", new List<string> { "value12" } }
                },
            ...
            user.IsActive.Should().Be(userRepresentation.Enabled!.Value);

            user.Attributes.Should().NotBeNull();
            user.Attributes.Should().HaveCount(4);
            user.Attributes!.ContainsKey("created_at").Should().BeTrue();
            user.Attributes!.ContainsKey("created_by").Should().BeTrue();
            user.Attributes!.ContainsKey("last_updated_at").Should().BeTrue();
            user.Attributes!.ContainsKey("last_updated_by").Should().BeTrue();
        }
        ...
        public void ToUserWithGroupsList()
        {
            ...
            users[0].IsActive.Should().Be(userRepresentation1.Enabled!.Value);

            users[0].Attributes.Should().NotBeNull();
            users[0].Attributes.Should().HaveCount(4);
            users[0].Attributes!.ContainsKey("created_at").Should().BeTrue();
            users[0].Attributes!.ContainsKey("created_by").Should().BeTrue();
            users[0].Attributes!.ContainsKey("last_updated_at").Should().BeTrue();
            users[0].Attributes!.ContainsKey("last_updated_by").Should().BeTrue();
            ...
            users[1].IsActive.Should().Be(userRepresentation2.Enabled!.Value);

            users[1].Attributes.Should().NotBeNull();
            users[1].Attributes.Should().HaveCount(4);
            users[1].Attributes!.ContainsKey("created_at").Should().BeTrue();
            users[1].Attributes!.ContainsKey("created_by").Should().BeTrue();
            users[1].Attributes!.ContainsKey("last_updated_at").Should().BeTrue();
            users[1].Attributes!.ContainsKey("last_updated_by").Should().BeTrue();
